  ...
  server.registerTool(
    "search_code",
    {
      ...
      inputSchema: {
        ...
        maxResults: z.number().int().min(1).max(20).default(10).describe("Max results (default 10, max 20)").optional(),
      },
