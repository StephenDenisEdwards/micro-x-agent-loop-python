...
class DispatchJobBranchTests(unittest.IsolatedAsyncioTestCase):
    async def test_job_arg_routes_to_handle_job_command(self) -> None:
...
class DispatchBrokerBranchTests(unittest.IsolatedAsyncioTestCase):
    async def test_broker_start_routes_to_run_server_with_broker_enabled(self) -> None:
        from micro_x_agent_loop.cli import dispatch as dispatch_module
    ...
    async def test_broker_empty_args_also_routes_to_run_server(self) -> None:
        from micro_x_agent_loop.cli import dispatch as dispatch_module
    ...
    async def test_broker_other_subcommand_routes_to_handle_broker_command(self) -> None:
        from micro_x_agent_loop.cli import dispatch as dispatch_module
...
class DispatchServerBranchTests(unittest.IsolatedAsyncioTestCase):
    async def test_server_start_routes_to_run_server(self) -> None:
        from micro_x_agent_loop.cli import dispatch as dispatch_module
    ...
    async def test_server_start_with_broker_flag_passes_through(self) -> None:
        from micro_x_agent_loop.cli import dispatch as dispatch_module
    ...
    async def test_server_url_routes_to_run_client(self) -> None:
        from micro_x_agent_loop.cli import dispatch as dispatch_module
    ...
    async def test_server_unknown_command_prints_usage(self) -> None:
        from micro_x_agent_loop.cli import dispatch as dispatch_module
...
class DispatchRunBranchTests(unittest.IsolatedAsyncioTestCase):
    async def test_run_routes_to_run_oneshot(self) -> None:
        from micro_x_agent_loop.cli import dispatch as dispatch_module
    ...
    async def test_missing_api_key_exits(self) -> None:
        from micro_x_agent_loop.cli import dispatch as dispatch_module
