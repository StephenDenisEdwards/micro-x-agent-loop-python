...
class ManifestTests(unittest.TestCase):
    def test_load_manifest_resolves_cwd_and_preserves_env(self) -> None:
        ...
        try:
            ...
            # Forwarding of the Agent's resolved config is now the
            # responsibility of McpManager._run_stdio (covered there).
            self.assertNotIn("MICRO_X_AGENT_CONFIG_JSON", server_config["env"])
        finally:
            if project_root.exists():
                shutil.rmtree(project_root)
