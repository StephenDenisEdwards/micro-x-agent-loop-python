...
| **12** | [Agent API Server](PLAN-agent-api-server.md) | **Phases 1–4 Complete** | HTTP/WebSocket API + broker convergence + CLI client. Phase 5 (SDKs) remaining |
...
| [Agent API Server](PLAN-agent-api-server.md) | Phases 1–4 Complete | HTTP/WebSocket API, broker convergence, CLI client. Phase 5 (SDKs) remaining |
