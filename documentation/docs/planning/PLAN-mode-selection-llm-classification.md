...
| 4 — Code generation and sandbox execution | LLM writes programs against MCP servers, sandbox runs them | **Blocked** — see [ADR-014](../architecture/decisions/ADR-014-mcp-unstructured-data-constraint.md) |
