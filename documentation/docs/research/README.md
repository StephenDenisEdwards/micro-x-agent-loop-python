...
| [model-tool-calling-and-free-apis.md](model-tool-calling-and-free-apis.md) | *(models / providers)* | Reliable tool calling: BFCL reliability tiers (27B+ floor), self-host VRAM reality vs 4GB GPU, free hosted APIs (Groq/Cerebras/OpenRouter), per-use-case picks |
