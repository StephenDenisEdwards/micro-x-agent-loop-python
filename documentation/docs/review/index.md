...
| [codebase-review-2026-06-05.md](codebase-review-2026-06-05.md) | Full-codebase audit — architecture, coding standards, type hygiene, test coverage & quality, structure | 2026-06-05 | **1 open item**: T2-6 (config-file reorganisation) — awaits user decision on target layout. T1 ✅ 9/9, T2 ✅ 7/8, T3 ✅ 7/7, T4 ✅ 6/6. Build green: ruff/mypy clean, 1886 tests pass; coverage 76% with a CI gate at 75%. |
