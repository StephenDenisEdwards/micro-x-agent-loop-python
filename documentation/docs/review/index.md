...
| [codebase-review-2026-06-05.md](codebase-review-2026-06-05.md) | Full-codebase audit — architecture, coding standards, type hygiene, test coverage & quality, structure | 2026-06-05 | 17 open items: T1 ✅ all 9 done; T2 ⚠️ 4/8 done (T2-3 Any→Protocol, T2-4 channel protocol drift, T2-7 PseudoToolHandler, T2-8 blocking subprocess; T2-5 partial); T3 (7); T4 (6). Build green: ruff/mypy clean, 1842 tests pass. |
