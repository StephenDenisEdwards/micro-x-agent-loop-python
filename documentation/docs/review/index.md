...
| [codebase-review-2026-06-05.md](codebase-review-2026-06-05.md) | Full-codebase audit — architecture, coding standards, type hygiene, test coverage & quality, structure | 2026-06-05 | ✅ **All 30 items addressed in v0.2.0.** T1 9/9, T2 8/8, T3 7/7, T4 6/6. Build green: ruff/mypy clean, 1886 tests pass; coverage 76% with a CI gate at 75%; root `config-*.json` count 36 → 3. |
| [codebase-review-2026-06-05-followups.md](codebase-review-2026-06-05-followups.md) | Second-pass re-audit + v0.2.1 cleanup + forward roadmap (v0.2.2 hygiene, v0.3.0 architecture) | 2026-06-05 | ✅ **All 8 v0.2.1 follow-ups addressed.** 13 forward-looking items prioritised across v0.2.2 (5 hygiene), v0.2.x (3 test quality), v0.3.0 (5 architecture). Build at v0.2.1: 1887 tests pass; 0 `# type: ignore` on `server/app.py`; 0 `Any` on `AgentComponents`. |
