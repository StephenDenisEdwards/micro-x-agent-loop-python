...
| [codebase-review-2026-06-05.md](codebase-review-2026-06-05.md) | Full-codebase audit — architecture, coding standards, type hygiene, test coverage & quality, structure | 2026-06-05 | 21 open items: T1 ✅ all 9 done (build now green: ruff/mypy clean, 1840 tests pass, ADR-024 CI gate added), T2 (8 architecture), T3 (7 test quality), T4 (6 hygiene) |
